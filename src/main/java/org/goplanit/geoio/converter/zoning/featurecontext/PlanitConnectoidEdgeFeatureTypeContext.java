  ...
  private static List<Triple<String,String, Function<ConnectoidLink, ?>>> createFeatureDescription(
    ...
    return List.of(
            Triple.of("mapped_id", "java.lang.String",
                    virtualNetworkIdMapper.getConnectoidLinkIdMapper()),
            Triple.of("id", "java.lang.Long",
                    IdAble::getId),
            Triple.of("link_id", "java.lang.Long",
                    ConnectoidLink::getLinkId),
            Triple.of("xml_id", "String",
                    ConnectoidLink::getXmlId),
            Triple.of("ext_id", "String",
                    ConnectoidLink::getExternalId),
            Triple.of("name", "String",
                    ConnectoidLink::getName),
            Triple.of("length_km", "java.lang.Double",
                    ConnectoidLink::getLengthKm),
            Triple.of("node_a", "String",
                    l -> virtualNetworkIdMapper.getVertexIdMapper().apply(l.getVertexA())),
            Triple.of("node_b", "String",
                    l -> virtualNetworkIdMapper.getVertexIdMapper().apply(l.getVertexB())),
